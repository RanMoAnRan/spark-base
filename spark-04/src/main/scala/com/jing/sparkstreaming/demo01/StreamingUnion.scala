...
object StreamingUnion {
  ...
  def main(args: Array[String]): Unit = {
     ...
     */
    //创建两个receiver
    val inputDStream01: DStream[String] = ssc.socketTextStream(
      "hadoop02", 9999, storageLevel = StorageLevel.MEMORY_AND_DISK)
    val inputDStream02: DStream[String] = ssc.socketTextStream(
      "hadoop02", 9998, storageLevel = StorageLevel.MEMORY_AND_DISK)
