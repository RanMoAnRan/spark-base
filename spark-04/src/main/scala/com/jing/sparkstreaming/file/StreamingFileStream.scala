package com.jing.sparkstreaming.file
...
/**
  * Streaming实时统计每批次数据中词频统计WordCount, 从File Stream中读取数据，将每批次结果打印到控制台。
  */
object StreamingFileStream {
	...
	def main(args: Array[String]): Unit = {
		 ...
		 */
		val inputDStream: DStream[String] = ssc.textFileStream("D:/streams/")
